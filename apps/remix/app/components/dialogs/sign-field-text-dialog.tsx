        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="mt-4">
              {copy?.description ?? <Trans>Please enter a value</Trans>}
            </DialogDescription>
          </DialogHeader>
            ...
            <form onSubmit={form.handleSubmit((data) => call.end(data.text))}>
              <fieldset className="flex h-full flex-col space-y-4" disabled={form.formState.isSubmitting}>
                ...
                <DialogFooter>
                  ...
                  <Button type="submit">{copy?.confirmLabel ?? <Trans>Enter</Trans>}</Button>
                </DialogFooter>
              </fieldset>
            </form>
          </Form>
