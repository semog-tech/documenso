...
import { EnvelopeRemarkAction } from './envelope-remark-action';
...
export const EnvelopeSignerHeader = () => {
  ...
  return (
    <nav className="embed--DocumentWidgetHeader flex max-w-screen flex-row flex-wrap justify-between gap-x-2 border-border border-b bg-background px-4 py-3 md:px-6">
      ...
      <div className="flex min-w-0 flex-1 items-center space-x-2">
        ...
        <div className="hidden min-w-0 items-center space-x-2 md:flex">
          <h1 title={envelope.title} className="min-w-0 truncate font-medium text-foreground text-sm">
            {envelope.title}
          </h1>
